function [X, e] = block_simulate(scanLength, TR, nconditions, ons, HPlength, dononlin,contrasts,HRFname)
...
% e = efficiency
% InitBias is the start time of the first block, in sec
% 
% see plotDesign onsets2fmridesign  create_orthogonal_contrast_set
% Modified by Kunru Song 2021.10.31
...
% intercept. One row per contrast.
    ...
    X = onsets2fmridesign(ons, TR, scanLength, HRFname, nonlinstr);
